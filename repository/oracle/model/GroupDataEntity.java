...
import com.paysafe.mastermerchant.repository.oracle.converter.GroupDataConverter;
...
public class GroupDataEntity {
  ...
  @Convert(converter = GroupDataConverter.class)
  private MasterMerchantDto data;
