...
public class GroupController {
  ...
  public ResponseEntity<MasterMerchantResponseResource> search(
  ...
  public ResponseEntity<MasterMerchantResponseResource> smartSearch(
      @ApiParam(value = "Authorization access token", required = true) @RequestHeader("Authorization") String auth,
      @ApiParam(value = "the search querywhich needs to be searched",
  ...
  public ResponseEntity<MasterMerchantRecordCreateResponseResource> createMasterMerchantRecord(
      @ApiParam(value = "Authorization access token", required = true) @RequestHeader("Authorization") String auth,
      @ApiParam(value = "Input Master merchant create request resource",
