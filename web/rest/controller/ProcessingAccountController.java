...
public class ProcessingAccountController {
   ...
   */
  @Autowired
  public ProcessingAccountController(ProcessingAccountService processingAccountService,
  ...
  public ResponseEntity<ProcessingAccountResource> getProcessingAccount(
      ...
      @ApiParam(value = "the id of the processing account record",
          required = true) @PathVariable("processingAccountId") String processingAccountId)
      throws Exception {
